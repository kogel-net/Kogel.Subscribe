    ...
    public static class Extensions
    {
        ...
        public static string GetString(this ReadOnlySequence<byte> buffer, Encoding encoding)
        {
            ...
            while (enumerator.MoveNext())
            {
                ...
                int chars = decoder.GetChars(bytes: current.Span.ToArray(), byteIndex: 0, byteCount: current.Span.Length,
                    chars: span2.ToArray(), charIndex: 0, false);

                var readChar = (chars == span2.Length) ? span2 : span2.Slice(0, chars);
                stringBuilder.Append(new string(readChar.ToArray()));
            }
